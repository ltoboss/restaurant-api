...
const SyncEntitiesClearCommand_1 = __importDefault(require("../API/Application/Commands/Sync/SyncEntitiesClearCommand"));
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        console.log('Clear Sync tmp entities');
        dotenv_1.default.config();
        let entitiesFiles = process.env.TYPEORM_ENTITIES_SYNC;
        yield CommandBus_1.default.handle(new SyncEntitiesClearCommand_1.default(process.env.APP_NAME));
    });
}
...
//# sourceMappingURL=sync-entities-clear.js.map