...
const RemovePidCommand_1 = __importDefault(require("../API/Application/Commands/CommandPids/RemovePidCommand"));
    ...
    return __awaiter(this, void 0, void 0, function* () {
        if (process.argv.length > 2) {
            switch (process.argv[2].toLocaleLowerCase()) {
                case 'all':
                    yield CommandBus_1.default.handle(new RemovePidCommand_1.default('all'));
                    break;
                case 'server':
                    yield CommandBus_1.default.handle(new RemovePidCommand_1.default('server'));
                    break;
                case 'sync':
                    yield CommandBus_1.default.handle(new RemovePidCommand_1.default('sync'));
                    break;
            }
        }
    });
