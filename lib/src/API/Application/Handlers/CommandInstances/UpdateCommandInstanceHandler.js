...
class UpdateCommandInstanceHandler {
    constructor() {
        this.commandInstanceServices = new CommandInstanceServices_1.default();
        this.validator = new Validator_1.default();
    }
    validate(command) {
        const error = this.validator.validate(command, CommandInstanceSchema_1.UpdateCommandInstanceSchema);
        if (error) {
    ...
    handle(command) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield this.commandInstanceServices.update(commandInstance);
        });
    }
}
exports.default = UpdateCommandInstanceHandler;
//# sourceMappingURL=UpdateCommandInstanceHandler.js.map