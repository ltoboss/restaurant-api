...
class CreateCommandInstanceHandler {
    constructor() {
        this.commandInstanceServices = new CommandInstanceServices_1.default();
        this.validator = new Validator_1.default();
    }
    validate(command) {
        const error = this.validator.validate(command, CommandInstanceSchema_1.StoreCommandInstanceSchema);
        if (error) {
...
exports.default = CreateCommandInstanceHandler;
//# sourceMappingURL=CreateCommandInstanceHandler.js.map