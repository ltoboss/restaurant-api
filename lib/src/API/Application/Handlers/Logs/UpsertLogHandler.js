...
class UpsertLogHandler {
    constructor() {
        this.logServices = new LogServices_1.default();
        this.validator = new Validator_1.default();
    }
    validate(command) {
        const error = this.validator.validate(command, LogSchema_1.UpsertLogSchema);
        if (error) {
    ...
    handle(command) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const match = yield this.logServices.findOne({ where: { id: log.getId() } });
            if (match)
                log.setId(match.getId());
            return yield this.logServices.store(log);
        });
    }
}
exports.default = UpsertLogHandler;
//# sourceMappingURL=UpsertLogHandler.js.map